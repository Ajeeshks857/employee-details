...
class UserRepository extends BaseRepository
{
    ...
    public function update(User $user, array $data)
    {
        ...
        return DB::transaction(function () use ($user, $data, $roles, $permissions) {
            ...
            $user->building_no = $data['building_no'] ?? null;
            $user->street_name = $data['street_name'] ?? null;
    ...
    protected function createUserStub($input)
    {
        ...
        $user->building_no = $input['building_no'] ?? null;
        $user->street_name = $input['street_name'] ?? null;
