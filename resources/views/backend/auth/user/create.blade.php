    ...
    <div class="card-body">
        ...
        <div class="row mt-4 mb-4">
            <div class="col">
                ...
                <div class="form-group row">
                    {{ Form::label('building_no', __('Building No'), [ 'class'=>'col-md-2 form-control-label']) }}

                    <div class="col-md-10">
                        {{ Form::text('building_no', null, ['class' => 'form-control', 'placeholder' => __('Building No')]) }}
                    </div>
                    <!--col-->
                </div>
                <!--form-group-->
                ...
                <div class="form-group row">
                    {{ Form::label('street_name', __('Street Name'), [ 'class'=>'col-md-2 form-control-label']) }}

                    <div class="col-md-10">
                        {{ Form::text('street_name', null, ['class' => 'form-control', 'placeholder' => __('Street Name')]) }}
                    </div>
                    <!--col-->
                </div>
                <!--form-group-->
                ...
                <div class="form-group row">
                    {{ Form::label('city', __('City'), [ 'class'=>'col-md-2 form-control-label']) }}
                ...
                <div class="form-group row">
                    {{ Form::label('state', __('State'), [ 'class'=>'col-md-2 form-control-label']) }}
                ...
                <div class="form-group row">
                    {{ Form::label('country', __('Country'), [ 'class'=>'col-md-2 form-control-label']) }}
                ...
                <div class="form-group row">
                    {{ Form::label('pincode', __('Pincode'), [ 'class'=>'col-md-2 form-control-label']) }}

                    <div class="col-md-10">
                        {{ Form::text('pincode', null, ['class' => 'form-control', 'placeholder' => __('Pincode')]) }}
                    </div>
                    <!--col-->
                </div>
                <!--form-group-->
